...
import Data from "../Data/MostPolluted.json";
import AirPollutionImg2 from "./images/383314-PCITS7-243.jpg";

export default function MostPolluted() {
	...
	return (
		<>
			...
			<h1 className="text-center font-bold text-2xl sm:text-4xl py-6 text-green-600">
				Most <span className="text-gray-600">Polluted</span> Countries
			</h1>
			<p className="text-center text-gray-500 pb-6 text-sm sm:text-lg font-medium">The table below shows the top 15 most polluted countries on the basis of the average PM 2.5.</p>
